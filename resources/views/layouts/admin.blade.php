...
<body class="min-h-screen bg-muted/30 font-sans text-foreground antialiased" x-data="{ sidebarOpen: false }">
    ...
    @php
        $nav = [
            ...
            ['label' => 'Notification Settings', 'route' => 'admin.sms-settings.edit', 'pattern' => 'admin.sms-settings.*', 'icon' => 'M8 10.5h8m-8 3h5m-9 5.25 2.7-2.7A1.5 1.5 0 0 1 7.94 18.6H18.75A2.25 2.25 0 0 0 21 16.35V6.75A2.25 2.25 0 0 0 18.75 4.5H5.25A2.25 2.25 0 0 0 3 6.75v12Z'],
        ];
    @endphp
